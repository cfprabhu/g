...
<form class="form-horizontal" action="#buildurl('appSettings.save')#" method="post" role="form">
	<fieldset>
		<cfif val(url.id)> 
			<legend>Edit Appsetting</legend>
		<cfelse>
			<legend>Add Appsetting</legend>
		</cfif>
		...
		<div class="form-group">
			...
			<div class="col-sm-6 controls">
				<input type="text" id="title" name="title" placeholder="title" 
				 class="form-control" value="#rc.qData.title#" 
				 <cfif #rc.qData.isSystem# eq 1>disabled </cfif>>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-6 controls">
				<input type="text" id="variable" name="variable" placeholder="variable" 
				class="form-control"  value="#rc.qData.variable#"
				<cfif #rc.qData.isSystem# eq 1>disabled</cfif>>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-1 controls">
				<input type="checkbox" id="isSystem" name="isSystem" placeholder="isSystem" 
				 class="form-control number" value="1" 
